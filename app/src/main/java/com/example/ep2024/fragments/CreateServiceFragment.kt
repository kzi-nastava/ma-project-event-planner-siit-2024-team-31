    ...
    private fun showAddCategoryDialog() {
        ...
        builder.setPositiveButton("Submit") { dialog, _ ->
            ...
            if (categoryName.isNotEmpty()) {
                ...
                Toast.makeText(requireContext(), "Category proposal sent to admin", Toast.LENGTH_SHORT).show()
            } else {
    ...
    private fun setupButtons() {
        ...
        binding.buttonSubmitService.setOnClickListener {
            ...
            if (validateForm()) {
                ...
                Toast.makeText(requireContext(), "Service submitted for moderation", Toast.LENGTH_SHORT).show()
