...
public class AuthRepositoryImpl implements AuthRepository {
    ...
    @Override
    public CommonMessageResponseDTO signup(RegisterRequestDTO req) throws Exception {
        Response<CommonMessageResponseDTO> response = apiService.signup(req).execute();
        if (response.isSuccessful() && response.body() != null) {
            return response.body();
        }
        else {
            throw new Exception("Signup Error");
        }
    }
